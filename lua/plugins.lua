...
packadd_defer({
  ...
  keymaps = {
    ...
    { keys = "<leader>fp",       command = "<cmd>FzfLua live_grep_resume<CR>",        options = { desc = "Previous search" } },
    { keys = "<leader>fw",       command = "<cmd>FzfLua grep_cword<CR>",        options = { desc = "Search for word under cursor" } },
    { keys = "<leader>fv",       command = "<cmd>FzfLua grep_visual<CR>",        options = { desc = "Search selected text" } },
